                        ...
                        <tbody>
                            <c:forEach var="item" items="${l}">
                                <tr>
                                    ...
                                    <td>${item.soluong}</td>
                                    <td style="color: #ff9933">${item.price}</td>

                                    <td>${item.giaoHang}</td>


                                    <td> <a class="btn btn-danger" href="/Admin/deleteDonHangDaGiao?id=${item.maKH}">Xóa</a>
                                        <a class="btn btn-primary" href="/Admin/updateDonHangDaGiao?&id=${item.maKH}">Sửa</a>
