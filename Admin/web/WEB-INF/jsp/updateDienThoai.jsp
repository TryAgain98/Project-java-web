        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="content" style="background: white;">
                <div class="animated fadeIn"><!-- content -->
                    ...
                    <h3> Cập Nhật Sản Phẩm ĐT</h3>
                    <hr>
                    <spring:form action="/Admin/saveUpdateDienThoai" method="post"  modelAttribute="p">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cameraT" value="${ctmt.cameraT}" id="exampleFormControlInput1" />
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput1" id="label">Camera Sau</label>
                                <input type="text" class="form-control" name="cameraS" value="${ctmt.cameraS}" id="exampleFormControlInput1" />
                            </div>
                           <div class="form-group">
                                <label for="exampleFormControlInput1" id="label">Sim</label>
                                <input type="text" class="form-control" name="sim" value="${ctmt.sim}" id="exampleFormControlInput1" />
                            </div>
